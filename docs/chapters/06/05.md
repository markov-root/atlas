...
<Figure src="./img/EZJ_Image_12.png" alt="Enter image alt description" number="12" label="6.12" caption="Illustration of different ways being pursued of achieving alignment. ([Cao et al., 2024](https://arxiv.org/abs/2406.01252))" />
...
<Figure src="./img/GXL_Image_13.png" alt="Enter image alt description" number="13" label="6.13" caption="Scalable agent alignment via reward modeling ([DeepMind, 2018](https://deepmindsafetyresearch.medium.com/scalable-agent-alignment-via-reward-modeling-bf4ab06dfd84))" />
...
<Figure src="./img/MqE_Image_14.png" alt="Enter image alt description" number="14" label="6.14" caption="Scalable agent alignment via reward modeling ([DeepMind, 2018](https://deepmindsafetyresearch.medium.com/scalable-agent-alignment-via-reward-modeling-bf4ab06dfd84))" />
...
<Figure src="./img/Owz_Image_15.gif" alt="Enter image alt description" number="15" label="6.15" caption="RLHF learned to backflip using around 900 individual bits of feedback from the human evaluator." />

<Figure src="./img/J0u_Image_16.gif" alt="Enter image alt description" number="16" label="6.16" caption="Manual reward crafting for this backflip took two hours to write a custom reward function. While it was successful, it was significantly less elegant than the one trained purely through human feedback. ([OpenAI, 2017](https://openai.com/index/learning-from-human-preferences/))" />
...
<Figure src="./img/lK5_Image_17.png" alt="Enter image alt description" number="17" label="6.17" caption="Aligning language models to follow instructions ([OpenAI, 2022](https://openai.com/research/instruction-following))" />
...
<Figure src="./img/sV0_Image_18.gif" alt="Enter image alt description" number="18" label="6.18" caption="Deep Reinforcement Learning From Human Preferences ([Christiano et al., 2017](https://arxiv.org/abs/1706.03741))" />

<Figure src="./img/Zo3_Image_19.png" alt="Enter image alt description" number="19" label="6.19" caption="A sensor without depth perception can be fooled by AIs that only appear to grasp a ball." />
...
<Figure src="./img/OtD-cai-graphic-final.png" alt="CAI Graphic Final" number="20" label="6.20" caption="([Anthropic, 2023](https://www.anthropic.com/index/claudes-constitution))" />
...
<Figure src="./img/mOW_Image_21.png" alt="Enter image alt description" number="21" label="6.21" caption="Constitutional AI: Harmlessness from AI Feedback ([Bai et al., 2022](https://arxiv.org/abs/2212.08073))" />
...
<Figure src="./img/q9F_Image_23.png" alt="Enter image alt description" number="23" label="6.23" caption="Example of instruction tuning." />
...
<Figure src="./img/rAi_Image_24.png" alt="Enter image alt description" number="24" label="6.24" caption="([Rafailov et al., 2023](https://arxiv.org/abs/2305.18290))" />
...
<Figure src="./img/0qv_Image_25.png" alt="Enter image alt description" number="25" label="6.25" caption="DPO increases the probability of the preferred action $y_w$ while decreasing the probability of the dispreferred action $y_l$." />
