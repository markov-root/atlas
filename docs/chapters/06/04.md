...
<Figure src="./img/oPd_Image_11.png" alt="Enter image alt description" chapter="6" figure="20" caption="A simple illustration of the flow difference between RL and IRL." />
