...
<Figure src="./img/oPd_Image_11.png" alt="Enter image alt description" number="11" label="6.11" caption="A simple illustration of the flow difference between RL and IRL." />
