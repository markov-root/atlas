...
<Video type="youtube" videoId="7MNyv2JER_o" number="1" label="5.1" caption="An optional video that showcases the insider trading evaluation conducted by Apollo Research." />
...
<Figure src="./img/Un6_Image_36.png" alt="Enter image alt description" number="34" label="5.34" caption="An illustration of resource acquisition, and self-improvement pipeline ([Phuong et al., 2024](https://arxiv.org/abs/2403.13793))." />
...
<Figure src="./img/BwA_Image_37.png" alt="Enter image alt description" number="35" label="5.35" caption="From METRs report ([METR, 2023](https://metr.org/blog/2023-08-01-new-report/))." />
...
<Figure src="./img/YCd_Image_40.png" alt="Enter image alt description" number="38" label="5.38" caption="Illustration showing how increasing capabilities according to compute levels, might result in situational awareness in an LLM as a function of scale ([Evans et al., 2023](https://arxiv.org/abs/2309.00667))." />
