...
<Figure src="./img/aQJ_Image_14.png" alt="Enter image alt description" chapter="5" figure="23" caption="Figure distinguishing the three related but distinct concepts of evaluated properties, the techniques used to evaluate model properties, and" />
