...
<Figure src="./img/T31_Image_52.png" alt="Enter image alt description" chapter="5" figure="99" caption="Basic setup for how we might structure control evaluations ([Greenblatt et al., 2024](https://arxiv.org/pdf/2312.06942.pdf))." />
...
<Figure src="./img/ybY_Image_55.png" alt="Enter image alt description" chapter="5" figure="102" caption="Illustration of how applying a safety or alignment technique could make the model less capable. This is called a safety tax." />
