...
<Figure src="./img/b0A_Image_33.png" alt="Enter image alt description" number="33" label="2.33" caption="Experts have been consistently underestimating the pace of AI progress." />
...
<Figure src="./img/K3m-alt_text.png" alt="alt_text" number="34" label="2.34" caption="Another prediction distribution by experts in 2022, that way undershot expected capabilities." />
...
<Figure src="./img/mbx_Image_35.png" alt="Enter image alt description" number="35" label="2.35" caption="For illustrative purposes. Figure from the French Center for AI Safety’s agenda." />
...
<Figure src="./img/GBC_Image_36.png" alt="Enter image alt description" number="36" label="2.36" caption="Example of the Kargu-2 lethal autonomous weapon ([Nasu, 2021](https://lieber.westpoint.edu/wp-content/uploads/2021/06/STM_Kargu.png))" />
