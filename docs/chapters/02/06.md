...
<Figure src="./img/pzU_Image_33.png" alt="Enter image alt description" number="33" label="2.33" caption="Experts have been consistently underestimating the pace of AI progress." />
...
<Figure src="./img/h9r-alt_text.png" alt="alt_text" number="34" label="2.34" caption="Another prediction distribution by experts in 2022, that way undershot expected capabilities." />
