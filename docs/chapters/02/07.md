...
<Figure src="./img/BrI_Image_36.png" alt="Enter image alt description" number="36" label="2.36" caption="Let's make sure this does not happen. Image by XKCD ([XKCD](https://xkcd.com/))" />